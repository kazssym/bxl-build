...
- In Visual Studio installer, under "Individual Components", search and install: "MSVC (v143) - VS 2022 C++ x64/x86 Spectre-mitigated libs" (the exact version will be detected automatically by Find-MsvcVersion.ps1)
